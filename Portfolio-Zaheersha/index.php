...
<style>
  ...
  <style>
        ...
        <div style="max-width: 1500px; margin: 0 auto;">
          <img src="images/gif-azs.gif" class="img-fluid">
        </div>
          ...
          <div id="about" class="container">
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-12 abc">
                ...
                <button class="btn w-50">
                  <a href="showcase.php#certification">Know More . . .</a>
                </button>
              </div>
            </div>
          </div>
...
<h4 class="text-black" color="balck" style="text-align: justify;">Machine Learning with Python Intern</h4>
                  ...
                  <div class="col"
                    ...
                    onmouseover="this.style.boxShadow='0 8px 16px 0 rgba(255, 255, 255, 0.4), 0 12px 40px 0 rgba(0, 0, 0, 0.3)';">
                    <div class="card shadow-sm">
                      <img class="bd-placeholder-img card-img-top" src="https://i.ibb.co/w033NjV/a5263c98-c56f-4873-8604-fb03e623da34.jpg" width="100%"
                        height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail"
                        preserveaspectratio="xMidYMid slice" focusable="false">
                      <rect width="100%" height="100%" fill="#55595c"></rect>
                      <div class="card-body">
                      <h3 class="text-black" color="balck" style="text-align: justify;">PHN Technologies PVT LTD </h3>
<h4 class="text-black" color="balck" style="text-align: justify;">Machine Learning and Data Science Intern Training </h4>
                        <h5 class="text-black" color="balck" style="text-align: justify;">April 2023 - June 2023</h5>
                        
                      <p class="text-black" color="balck" style="text-align: justify;"> I undertook the role of a Machine Learning and Data Science Intern, gaining valuable experience and knowledge. Through intensive training, I developed a deep understanding of advanced data analysis techniques and the application of machine learning algorithms.</p>
                      <ul class="text-black" color="balck" style="text-align: justify;">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                          <div class="btn-group">
                            <button type="button" class="btn btn-sm btn-outline-secondary"><a
                                href="https://i.ibb.co/w033NjV/a5263c98-c56f-4873-8604-fb03e623da34.jpg">View </a></button>

                          </div>
                          <small class="text-muted">PHN Technologies PVT LTD </small>
                        </div>
                      </div>
                    </div>
                  </div>
...
<h4 class="text-black" color="balck" style="text-align: justify;">WEB DEVELOPMENT AND DESIGN</h4>
                     ...
                     <div class="carousel-item">
                      <!-- <img src="..." class="d-block w-100" alt="..."> -->
                      <div class="card shadow-sm">
                        <img class="bd-placeholder-img card-img-top" src="https://i.ibb.co/w033NjV/a5263c98-c56f-4873-8604-fb03e623da34.jpg"
                          width="100%" height="400" xmlns="http://www.w3.org/2000/svg" role="img"
                          aria-label="Placeholder: Thumbnail" preserveaspectratio="xMidYMid slice" focusable="false">
                        <rect width="100%" height="100%" fill="#55595c"></rect>
                        <div class="card-body">
                    ...
                    <div class="carousel-item active">
                      ...
                      <div class="col"
                        ...
                        <div class="card shadow-sm">
                          ...
                          <rect width="100%" height="100%" fill="#55595c"></rect>
                          <div class="card-body">
                      <h3 class="text-black" color="balck" >TRAINING AND PLACEMENTS WEBSITE</h3>
        ...
        <div id="about" class="container">
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12 abc">
              ...
              <button class="btn w-50">
                <a href="showcase.php#projects">Know More . . .</a>
              </button>
            </div>
          </div>
        </div>
              ...
              <div class="container">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                  <div class="col"
                    ...
                    onmouseover="this.style.boxShadow='0 8px 16px 0 rgba(255, 255, 255, 0.4), 0 12px 40px 0 rgba(0, 0, 0, 0.3)';">
                    <div class="card shadow-sm">
                   <img class="bd-placeholder-img card-img-top" src="https://i.ibb.co/42xRrv8/e6190992-e696-415a-9246-c3d6ac7b45a4.jpg" width="100%"
                        height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail"
                        preserveaspectratio="xMidYMid slice" focusable="false">
                      <rect width="100%" height="100%" fill="#55595c"></rect>
                      <div class="card-body">
          ...
          <div id="about" class="container">
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-12 abc">
                ...
                <button class="btn w-50">
                  <a href="showcase.php#activities">Know More . . .</a>
                </button>
              </div>
            </div>
          </div>
        ...
        <div class="w-50 mx-auto mt-5 pb-5">
          ...
          <div class="p-4 pb-0">
            ...
            <section class="mb-4">
              ...
              <a href="https://www.linkedin.com/in/akula-zaheer-sha-0899471a1/" class="btn text-white btn-floating m-1" role="button">
